...
const DataVisualization = () => {
    ...
    const unapprovedOrders = orders.filter((order) => !order.aprroved && !order.isCanceld);
    ...
    // Calculate your total income which is 5% of the total income from all approved orders.
    const myIncome = 0.05 * totalApprovedPrice;
